"""Application service for running pattern detection rules against an Erlang CodeModel."""
...
class DetectionService(DetectorPort):
    """Coordinates the execution of all registered Erlang pattern detection rules."""
