"""Base abstractions and protocol for Erlang pattern detection rules."""
...
class PatternRule(Protocol):
    """Protocol that every Erlang pattern detection rule must satisfy."""
...
class BasePatternRule(ABC):
    """Base class for Erlang/OTP pattern rules."""
