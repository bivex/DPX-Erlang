"""Detection and Report domain entities for Erlang / OTP Pattern Detector."""
...
class Detection:
    """Represents an identified Erlang design pattern, OTP behaviour, or architecture smell."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "module", "function", "process_loop", "supervisor", "ets_table"
...
class DetectionReport:
    """Aggregated findings report of an Erlang codebase scan."""
