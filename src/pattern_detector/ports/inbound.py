"""Inbound (driver) ports for the Erlang pattern detector application layer."""
...
@dataclass
class ScanOptions:
    """Configuration options for an Erlang codebase scan execution."""
...
class ScannerPort(Protocol):
    """Primary inbound port for scanning Erlang codebases and returning DetectionReports."""
...
class DetectorPort(Protocol):
    """Inbound port for executing pattern detection rules on an Erlang CodeModel."""
