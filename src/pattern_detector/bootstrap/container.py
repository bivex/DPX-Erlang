"""Dependency Injection container wiring hexagonal ports and adapters for DPX-Erlang."""
...
class Container:
    """IoC container managing singleton services and adapters for DPX-Erlang."""
    ...
    def parser(self) -> ParserPort:
        if self._parser is None:
            self._parser = NativeErlangParserAdapter()
        return self._parser
